...
const Footer: React.FC<FooterProps> = ({isLearning }) => {
  return (
    <footer className={ ` ${isLearning ? "bg-none" : "bg-[#353535]"} text-white  min-h-auto`}>
      {/* <section className="bg-gray-900 py-16 text-center"> */}
      <div className={ `${isLearning ? "bg-white/5" : "bg-white -mt-40"} max-w-screen border-b border-primary/50 h-96`}></div>
