...
export default function Grade9ChemistryBooks() {
  

  return (
    <div className="p-6 text-center">
      <BackButton/>
      <h1 className="text-2xl sm:text-4xl font-bold text-white mb-8 mt-8 ">Grade 9 <span className='text-primary'>Chemistry</span> Extra Books & Solutions</h1>
