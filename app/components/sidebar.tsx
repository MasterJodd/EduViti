  ...
  const Sidebar: React.FC<SidebarProps> = ({links, selected, setSelected, isSidebarVisible,setIsSidebarVisible }) => {
    const toggleSidebar = () => {
    ...
    return (
      <div className="flex">
        ...
        >
          <a href="/" className="flex duration-200 hover:scale-105 items-center mb-4 space-x-3">
